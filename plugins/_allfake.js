...
handler.all = async function (m) {
    ...
    //creador y otros
    global.creador = 'Wa.me/51924636698'
    global.ofcbot = `${conn.user.jid.split('@')[0]}`
    global.asistencia = 'https://wa.me/qr/PAOHAKCEHGUXN1'
    global.namechannel = '@gatlu_20'
    ...
    //Emojis determinado de KATLUBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51924636698-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
